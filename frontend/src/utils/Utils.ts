...
export const getDescriptionForChatMode = (mode: string): string => {
  switch (mode.toLowerCase()) {
    case chatModeLables['agentic rag']:
      return 'Runs a controlled Agentic RAG loop over Postgres vector/BM25, Neo4j graph tools and optional Yandex Web Search. It returns cited evidence, gaps, contradictions and confidence.';
